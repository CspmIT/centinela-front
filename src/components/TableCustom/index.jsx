		...
		muiPaginationProps: {
			...
			sx: {
				'& .MuiPaginationItem-root': {
					...
					fontWeight: 500,
					color: '#1f2937',
					'&:hover': { backgroundColor: 'rgba(227, 106, 0, 0.1)' },
				},
				'& .MuiPaginationItem-root.Mui-selected': {
					backgroundColor: '#e36a00',
					color: '#ffffff',
					fontWeight: 600,
					'&:hover': { backgroundColor: '#a14b00' },
				},
				'body.dark & .MuiPaginationItem-root': {
					color: '#e5e7eb',
					'&:hover': { backgroundColor: 'rgba(251, 146, 60, 0.15)' },
				},
		...
		muiTableBodyProps: {
			sx: () => ({
				...
				'& tr:not([data-selected="true"]):not([data-pinned="true"]):hover > td': {
					backgroundColor: 'rgba(227, 106, 0, 0.08) !important',
				},
				'& tr:not([data-selected="true"]):not([data-pinned="true"]):hover > td:first-of-type': {
					boxShadow: 'inset 3px 0 0 #e36a00',
				},
