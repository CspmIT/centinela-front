		...
		<div className='!w-full'>
			<ListItemButton
				...
				sx={{
					...
					backgroundColor:
						!isMobile && hasActiveChild ? 'rgba(208, 94, 0, 0.08)' : 'transparent',
					'&:hover': {
							...
							return (
								<ListItemButton
									...
									sx={{
										...
										'&:hover': {
											backgroundColor: isActive ? 'rgba(208, 94, 0, 0.14)' : 'rgba(208, 94, 0, 0.06)',
										},
									}}
								>
					...
					<ClickAwayListener onClickAway={handleClose}>
						<Paper
							...
							sx={{
								...
								boxShadow: '0 18px 40px -12px rgba(135, 51, 0, 0.28), 0 4px 12px -4px rgba(135, 51, 0, 0.12)',
									...
									return (
										<MenuItem
											...
											sx={{
												...
												'& .submenu-icon': {
													color: isActive ? '#d05e00' : 'rgb(100, 116, 139)',
													transition: 'color 150ms ease',
												},
												'&:hover': {
													backgroundColor: isActive ? 'rgba(208, 94, 0, 0.16)' : 'rgba(208, 94, 0, 0.08)',
													color: '#d05e00',
												},
												'&:hover .submenu-icon': {
													color: '#d05e00',
