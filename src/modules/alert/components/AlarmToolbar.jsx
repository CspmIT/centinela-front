	...
	return (
		<div
			...
			style={{
				...
				boxShadow:
					'0 2px 6px rgba(227,106,0,0.18), 0 10px 22px -10px rgba(227,106,0,0.38), inset 0 1px 0 rgba(255,255,255,0.14)',
						...
						return (
							<button
								...
								className={[
									...
									active ? 'text-[#a14b00]' : 'text-slate-500 hover:text-slate-800',
								].join(' ')}
								style={
									active
										? {
												background:
													'linear-gradient(180deg, rgba(227,106,0,0.18) 0%, rgba(227,106,0,0.08) 100%)',
								...
								<span
									...
									style={
										active
											? {
													background:
														'linear-gradient(145deg, #e36a00 0%, #a14b00 100%)',
													color: '#ffffff',
													boxShadow:
														'0 1px 2px rgba(227,106,0,0.3), inset 0 1px 0 rgba(255,255,255,0.25)',
											  }
											: {
													background: '#e2e8f0',
													color: '#64748b',
					...
					<TextField
						...
						sx={{
							'& .MuiOutlinedInput-root': {
								...
								'&:hover fieldset': { borderColor: 'rgba(227,106,0,0.4)' },
