...
// Reutilizan los tokens del módulo Assistant: navy #a14b00, naranja #e36a00,
...
const Eyebrow = ({ children }) => (
    <span className='text-[10.5px] font-semibold uppercase tracking-[0.18em] text-[#e36a00] dark:text-[#fcbf8a]'>
        {children}
    </span>
)
...
const SectionPanel = ({ title, action, children, className = '' }) => (
    <section
        className={`rounded-2xl border border-[#a14b00]/10 dark:border-white/10 bg-white dark:bg-white/[0.02] shadow-[0_1px_3px_rgba(15,42,68,0.04),0_14px_34px_-26px_rgba(15,42,68,0.35)] overflow-hidden ${className}`}
    >
        <div className='flex items-center justify-between gap-2 px-3.5 py-1.5 border-b border-[#a14b00]/8 dark:border-white/5'>
            <div className='flex items-center gap-2 min-w-0'>
                <span className='inline-block w-1.5 h-1.5 rounded-full bg-[#e36a00]' aria-hidden />
...
const RoomTile = ({ label, value, suffix }) => {
    ...
    return (
        <div className='rounded-xl border border-[#a14b00]/10 dark:border-white/10 bg-slate-50/60 dark:bg-white/[0.025] px-2.5 py-2 text-center transition-colors hover:border-[#e36a00]/35 hover:bg-[#e36a00]/[0.04]'>
...
const BoardChart = memo(
    ({
        ...
        return (
            <div className='w-full md:h-[calc(100dvh-100px)] min-h-[420px] rounded-3xl border border-[#a14b00]/8 dark:border-white/10 bg-white dark:bg-slate-900/50 shadow-[0_2px_8px_rgba(15,42,68,0.05),0_24px_56px_-30px_rgba(15,42,68,0.28)] overflow-hidden flex flex-col'>
                {/* HEADER */}
                <div className='relative px-3.5 py-2.5 bg-gradient-to-br from-[#e36a00] to-[#a14b00] overflow-hidden'>
                ...
                <div className='p-2.5 flex flex-col gap-2 md:flex-1 md:min-h-0'>
                    ...
                    >
                        <div className='grid grid-cols-1 md:grid-cols-2 gap-2.5 p-3'>
                            <div className='rounded-xl border border-[#a14b00]/10 dark:border-white/10 bg-slate-50/50 dark:bg-white/[0.02] px-3.5 py-1 divide-y divide-[#a14b00]/8 dark:divide-white/5'>
                                <MetricRow
