...
const editSx = {
	...
	boxShadow: '0 3px 10px rgba(227, 106, 0, 0.3)',
	'&:hover': {
		background: 'linear-gradient(135deg, #e36a00 0%, #a14b00 100%)',
		boxShadow: '0 6px 16px rgba(227, 106, 0, 0.4)',
	},
}
...
const tonePalette = {
	...
	info: { border: 'rgba(227, 106, 0, 0.4)', borderHover: '#e36a00', bg: 'rgba(227, 106, 0, 0.08)', color: '#b45309' },
