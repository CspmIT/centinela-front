...
const chartCardSx = (index = 0, disabled = false) => ({
    ...
    '&:hover': disabled
        ...
        : {
              ...
              boxShadow:
                  '0 4px 10px rgba(15, 42, 68, 0.06), 0 24px 46px -14px rgba(227, 106, 0, 0.35)',
                ...
                {chartTypes.map((chart, index) => (
                    ...
                    >
                        <div className='relative h-44 overflow-hidden bg-gradient-to-b from-slate-50 to-slate-100 dark:from-slate-800/60 dark:to-slate-900/60 flex items-center justify-center'>
                            ...
                            />
                            <div className='absolute top-2 left-2 px-2 py-0.5 rounded-full bg-[#e36a00] text-white text-[10px] font-semibold uppercase tracking-[0.12em] shadow-sm'>
                                Tipo {chart.id}
                            </div>
                        </div>
