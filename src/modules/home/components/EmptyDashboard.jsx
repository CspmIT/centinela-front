...
const FloatingWidget = ({ className = '', style, children }) => (
	<div
		className={`absolute rounded-xl border border-slate-200/80 dark:border-gray-700/60 bg-white/95 dark:bg-gray-900/70 backdrop-blur-sm shadow-[0_4px_16px_rgba(227,106,0,0.08)] dark:shadow-[0_4px_16px_rgba(0,0,0,0.4)] px-3 py-2.5 text-[11px] text-slate-500 dark:text-gray-400 whitespace-nowrap ${className}`}
		style={style}
	>
		{children}
	</div>
...
export default function EmptyDashboard({ onAddChart }) {
	...
	return (
		...
		>
			<div className='relative w-[280px] h-[180px] mb-10'>
				...
				>
					<svg viewBox='0 0 80 80' fill='none' width='58' height='58'>
						...
						<circle cx='40' cy='40' r='28' stroke='#e36a00' strokeWidth='8' strokeDasharray='105 70' strokeDashoffset='35' strokeLinecap='round' />
					...
					<svg viewBox='0 0 80 80' fill='none' width='80' height='64'>
						{[
							...
							<g key={i}>
								...
								<rect x={led.x + 18} y={led.y + 4} width='20' height='4' rx='2' fill={led.on ? '#e36a00' : '#cbd5e1'} />
				...
				>
					<svg viewBox='0 0 80 80' fill='none' width='68' height='58'>
						...
						<path d='M12 58 A30 30 0 0 1 52 22' stroke='#e36a00' strokeWidth='8' strokeLinecap='round' />
				...
				<div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-br from-[#e36a00] to-[#a14b00] shadow-[0_4px_16px_rgba(227,106,0,0.35)]'>
					<span className='absolute inset-0 rounded-full bg-[#e36a00] opacity-40 animate-ping' />
			...
			<h2 className='text-[11px] font-semibold uppercase tracking-[0.2em] text-[#e36a00] dark:text-[#fb923c] mb-2'>
				Dashboard vacío
			</h2>
			...
			<button
				onClick={onAddChart}
				className='group inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-gradient-to-br from-[#e36a00] to-[#a14b00] text-white text-sm font-medium tracking-wide shadow-[0_4px_14px_rgba(227,106,0,0.35)] hover:shadow-[0_8px_24px_rgba(227,106,0,0.45)] hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200'
			>
