...
import { FaTachometerAlt, FaChartLine, FaCogs, FaFile, FaMapMarkedAlt, FaProjectDiagram, FaChartBar } from 'react-icons/fa'
...
const ListIcon = () => [
	{ title: 'SCADA', name: 'MdSchema', icon: <MdSchema className=' text-3xl' /> },
	...
	{ title: 'Dashboard', name: 'FaTachometerAlt', icon: <FaTachometerAlt className=' text-3xl' /> },
	...
	{ title: 'Graficos Bar', name: 'FaChartBar', icon: <FaChartBar className=' text-3xl' /> },
]
