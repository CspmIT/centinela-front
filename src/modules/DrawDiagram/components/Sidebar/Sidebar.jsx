...
const sidebarShellSx = {
  ...
  background: 'linear-gradient(180deg, #e36a00 0%, #a14b00 50%, #a14b00 100%)',
  color: '#f8fafc',
};
...
const iconButtonOnDarkPrimarySx = {
  width: 40,
  height: 40,
  borderRadius: '10px',
  color: '#ffffff',
  ...
  '&:hover': {
    background: 'linear-gradient(135deg, #fb923c 0%, #e36a00 100%)',
    boxShadow:
      '0 8px 24px rgba(227, 106, 0, 0.6), inset 0 1px 0 rgba(255, 255, 255, 0.25)',
