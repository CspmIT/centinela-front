...
import { Add, Delete, Edit, Security, RestartAltOutlined } from '@mui/icons-material'
...
const tableShellSx = {
	...
	'& tbody tr:hover td': { backgroundColor: 'rgba(227, 106, 0, 0.08) !important' },
	'& tbody tr:hover td:first-of-type': { boxShadow: 'inset 3px 0 0 #e36a00' },
	'body.dark & tbody tr:hover td': { backgroundColor: 'rgba(251, 146, 60, 0.1) !important' },
	'body.dark & tbody tr:hover td:first-of-type': { boxShadow: 'inset 3px 0 0 #fb923c' },
}
								...
								<Fragment key={menu.id}>
									<TableRow data-parent='true'>
										<TableCell sx={{ display: { xs: 'none', sm: 'table-cell' } }} align='center'>
											<Box sx={{ color: '#e36a00', 'body.dark &': { color: '#fb923c' }, display: 'inline-flex' }}>
													...
													<IconButton
														...
														sx={{
															...
															'body.dark &': {
																...
																'&:hover': { backgroundColor: '#fb923c', color: '#0f172a' },
															},
														}}
													>
														<Add sx={{ fontSize: 14 }} />
										...
										<TableCell align='right'>
											<Stack direction='row' spacing={0.5} justifyContent='flex-end'>
												...
												<Tooltip title='Permisos'>
													<IconButton size='small' onClick={() => managePermissions(menu)} sx={actionIconSx('#e36a00', '#fb923c')}>
										...
										<TableRow key={sub.id} data-parent='false'>
												...
												<Box sx={{ display: 'inline-flex', alignItems: 'center', gap: 1, pl: 4 }}>
													<Box
														sx={{
															width: 16,
															height: 1,
															backgroundColor: 'rgba(227, 106, 0, 0.4)',
															'body.dark &': { backgroundColor: 'rgba(251, 146, 60, 0.5)' },
														}}
													/>
											...
											<TableCell align='right'>
												<Stack direction='row' spacing={0.5} justifyContent='flex-end'>
													...
													<Tooltip title='Permisos'>
														<IconButton size='small' onClick={() => managePermissions(sub)} sx={actionIconSx('#e36a00', '#fb923c')}>
															<Security sx={{ fontSize: 18 }} />
														</IconButton>
													</Tooltip>
												</Stack>
