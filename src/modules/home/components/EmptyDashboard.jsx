...
const FloatingWidget = ({ style, children }) => (
    <div style={{
        ...
        borderRadius: 12,
        padding: "10px 14px",
        boxShadow: "0 4px 16px rgba(208,94,0,0.08)",
        fontSize: 11,
        color: "#64748b",
        whiteSpace: "nowrap",
        ...style
        ...
        <div style={{
            ...
            <button
                ...
                style={{
                    ...
                    fontSize: 14,
                    cursor: "pointer",
                    boxShadow: "0 4px 14px rgba(208,94,0,0.08)",
                    transition: "transform 0.15s, box-shadow 0.15s",
                }}
                onMouseEnter={e => {
                    e.currentTarget.style.transform = "translateY(-1px)"
                    e.currentTarget.style.boxShadow = "0 6px 20px rgba(208,94,0,0.08))"
                }}
                onMouseLeave={e => {
                    e.currentTarget.style.transform = "none"
                    e.currentTarget.style.boxShadow = "0 4px 14px rgba(208,94,0,0.08)"
                }}
            >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
