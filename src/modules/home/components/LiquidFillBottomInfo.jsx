					...
					{Array.from({ length: totalPages }).map((_, i) => (
						<ButtonBase
							...
							sx={{
								...
								width: i === page ? 14 : 5,
								borderRadius: 99,
								bgcolor: i === page ? '#e36a00' : 'rgb(203 213 225)',
								'.dark &': {
									bgcolor: i === page ? '#fb923c' : 'rgb(75 85 99)',
								},
								transition: 'width 0.25s cubic-bezier(0.4, 0, 0.2, 1), background-color 0.2s',
								minWidth: 0,
								p: 0,
								'&:hover': {
									bgcolor: i === page ? '#e36a00' : 'rgb(148 163 184)',
								},
							}}
						/>
					))}
