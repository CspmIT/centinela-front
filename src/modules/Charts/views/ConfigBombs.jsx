            ...
            <Card className='w-full h-full !shadow-none'>
                <CardContent>
                    {states.map((item) => (
                        <div
                            key={item.id}
                            className='relative flex justify-center items-center gap-2 mb-2 px-3 py-1.5 bg-slate-50/30 border-2 border-orange-200 rounded-xl'
                        >
                    ...
                    <div className='flex flex-wrap items-stretch justify-center gap-2'>
                        {pumps.map((pump) => (
                            <div
                                key={pump.id}
                                className='relative flex-1 min-w-[90px] flex flex-col justify-center items-center px-3 py-2 bg-slate-50/30 border-2 border-orange-200 rounded-xl'
                            >
                                <h4 className='text-sm text-center text-slate-600'>{pump.name}</h4>
                                <p className='text-lg text-center font-bold text-[#e36a00]'>
    ...
    return (
        <>
            <Container maxWidth={false} disableGutters className='w-full px-3 sm:px-5 pt-2 pb-4'>
                <HeaderForms idChart={false} chart={{ name: title }} />
