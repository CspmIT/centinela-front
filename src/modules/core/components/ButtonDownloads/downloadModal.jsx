...
function SectionHeader({ icon: Icon, title, badge }) {
	return (
		<div className='flex items-center gap-2 mb-1.5'>
			...
			{badge && (
				<span className='ml-auto whitespace-nowrap text-[10px] font-semibold text-[#e36a00] bg-[#e36a00]/10 border border-[#e36a00]/20 rounded-full px-2 py-[2px]'>
					{badge}
				</span>
			)}
		</div>
